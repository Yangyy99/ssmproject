                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick="location.href='${pageContext.request.contextPath}/role-add.jsp'">
                            ...
                            <c:forEach items="${roleList}" var="role">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/role/delete.do?id=${role.id}"
                                        ...
                                        <a href="${pageContext.request.contextPath}/role/findRoleByIdAndOtherPermission.do?id=${role.id}"
                                           class="btn bg-olive btn-xs">删除角色权限</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
