        ...
        <section class="content">
            ...
            <div class="box box-primary">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/productAdd.jsp'"><i class="fa fa-file-o"></i> 新建</button>
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            总共${pageInfo.pages}页，共${pageInfo.list.size()}条数据。每页 ${pageInfo.pageSize}条
